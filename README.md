...
This repository contains the service which provides capabilities for public services catalog management.
...
In order to install and use the linked dependencies for `public-service-catalog` the following command can be used:
